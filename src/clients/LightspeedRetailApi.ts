...
class LightspeedRetailApi {
  ...
  constructor(opts: ConstructorOptions) {
    const { clientId, clientSecret, refreshToken, version, accountId } = opts;
  ...
  async postItem(item) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Item.json`;
  ...
  async postCustomerType(customerType) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/CustomerType.json`;
  ...
  async postItemAttributeSet(attributeSet) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/ItemAttributeSet.json`;
  ...
  async postItemMatrix(itemMatrix) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/ItemMatrix.json`;
  ...
  async postItemCustomField(customField) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Item/CustomField.json`;
  ...
  async postPaymentMethod(paymentMethod) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/PaymentType.json`;
  ...
  async postCustomerCustomField(customField) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Customer/CustomField.json`;
  ...
  async postSale(sale: PostSale): Promise<Sale> {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Sale.json`;
  ...
  async putItemMatrix(matrix, ID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/ItemMatrix/${ID}.json`;
  ...
  async putCustomer(customer, ID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Customer/${ID}.json`;
  ...
  async getAccount() {
    const url = 'https://api.merchantos.com/API/${this.version}/Account.json';
  ...
  async getTaxCategory(taxCategoryId): Promise<TaxCategory> {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/TaxCategory/${taxCategoryId}.json`;
  ...
  getCompletedSalesByPeriod(start, end) {
    let url = null;
    if (end == undefined) {
      url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Sale.json?completed==true&completeTime=${encodeURIComponent(
        `>,${start}`
      )}`;
    } else {
      url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Sale.json?completed==true&completeTime=${encodeURIComponent(
  ...
  getSales() {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Sale.json`;
    return new RetailApiCursor(url, 'Sale', this, {
      load_relations:
        '["TaxCategory","SaleLines","SaleLines.Item","SalePayments","SalePayments.PaymentType","Customer","Discount","Customer.Contact"]',
    });
  ...
  public async getSale(saleId) {
    ...
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Sale/${saleId}.json?${querystring.stringify(
      queryString
    )}`;
    const options = {
      method: 'GET',
  ...
  async getSalePaymentByID(salePaymentID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/SalePayment/${salePaymentID}.json`;
  ...
  async getSalePaymentBySaleID(saleID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/SalePayment.json?saleID=${saleID}`;
  ...
  async getSaleLineBySaleID(saleID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/SaleLine.json?saleID=${saleID}`;
  ...
  async getSaleLineByID(saleLineID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/SaleLine/${saleLineID}.json`;
  ...
  async getPaymentTypeByID(paymentTypeID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/PaymentType/${paymentTypeID}.json`;
  ...
  async getShopByID(shopID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Shop/${shopID}.json`;
  ...
  async getDiscountByID(discountID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Discount/${discountID}.json`;
  ...
  async getCustomerByID(customerID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Customer/${customerID}.json?load_relations=["CustomFieldValues", "CustomFieldValues.value"]`;
  ...
  async getContactByID(contactID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Contact/${contactID}.json`;
  ...
  async getItemMatrixByID(itemMatrixID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/ItemMatrix/${itemMatrixID}.json`;
  ...
  async getItemsByMatrixID(itemMatrixID) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Item.json?itemMatrixID=${itemMatrixID}`;
  ...
  async getItemByCustomSku(customSku) {
    const url = `https://api.lightspeedapp.com/API/${this.version}/Account/${this.accountId}/Item.json?customSku=${customSku}`;
  ...
  async getItemById(
    ...
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Item/${itemId}.json?load_relations=${querystring.escape(
  ...
  getCategories() {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Category.json`;
    return new RetailApiCursor(url, 'Category', this);
  }

  getManufacturers() {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/Manufacturer.json`;
  ...
  getPaymentTypes() {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/PaymentType.json`;
  ...
  getCustomerTypes() {
    const url = `https://api.merchantos.com/API/${this.version}/Account/${this.accountId}/CustomerType.json`;
